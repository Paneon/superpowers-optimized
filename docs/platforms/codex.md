...
```bash
git clone https://github.com/Paneon/superpowers-optimized.git ~/.codex/superpowers-optimized
```
...
git clone https://github.com/Paneon/superpowers-optimized.git "$env:USERPROFILE\.codex\superpowers-optimized"
