...
```
Clone https://github.com/Paneon/superpowers-optimized.git to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugins, then symlink ~/.config/opencode/superpowers/.opencode/plugins/superpowers-optimized.js to ~/.config/opencode/plugins/superpowers-optimized.js, then symlink ~/.config/opencode/superpowers/skills to ~/.config/opencode/skills/superpowers, then restart opencode.
```
...
if [ -d ~/.config/opencode/superpowers ]; then
  ...
  git clone https://github.com/Paneon/superpowers-optimized.git ~/.config/opencode/superpowers
fi
...
git clone https://github.com/Paneon/superpowers-optimized.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/Paneon/superpowers-optimized.git "$env:USERPROFILE\.config\opencode\superpowers"
...
- Main documentation: https://github.com/Paneon/superpowers-optimized
